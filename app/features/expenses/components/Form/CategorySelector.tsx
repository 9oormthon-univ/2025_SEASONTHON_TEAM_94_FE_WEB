...
const CATEGORIES: ReadonlyArray<{
  ...
  { id: EXPENSE_CATEGORIES.TRANSPORT, label: '교통', icon: '/app/assets/category/transit.svg' },
  { id: EXPENSE_CATEGORIES.BEAUTY, label: '패션/미용', icon: '/app/assets/category/fashion.svg' },
  { id: EXPENSE_CATEGORIES.SHOPPING, label: '편의점', icon: '/app/assets/category/convenience_store.svg' },
  { id: EXPENSE_CATEGORIES.GROCERIES, label: '생활용품', icon: '/app/assets/category/essentials.svg' },
  { id: EXPENSE_CATEGORIES.HOUSING, label: '가구', icon: '/app/assets/category/furniture.svg' },
  { id: EXPENSE_CATEGORIES.SUBSCRIPTIONS, label: '경조사/회비', icon: '/app/assets/category/dues.svg' },
  { id: EXPENSE_CATEGORIES.HEALTHCARE, label: '자기계발', icon: '/app/assets/category/growth.svg' },
    ...
    <div className="px-4 sm:px-6">
      <div className="py-4 border-b border-[#F5F5F5]">
        <div className="flex justify-between items-center mb-4">
          <span className="text-base text-[#3d3d3d] font-medium">카테고리</span>
          {errors.category && (

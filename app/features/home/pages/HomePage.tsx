...
export default function HomePage() {
  const {
    ...
    userName, total, totalCount, monthlyGoal, leftToGoal, ratio, isOver, hasGoal, hasExpense, loading,
  } = useHome();
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] relative max-w-md mx-auto pb-20">
      <div className="bg-[#F1F5F9] py-4">
        <div className="px-5 mt-13">
          <div className="flex items-center justify-between">
            <h2 className="text-[21px] font-bold text-[#111111]">
              {userName} 님
            </h2>
          ...
          <div className="mt-5">
            <button
              ...
              className="inline-flex items-center gap-1 text-[12px] font-semibold text-[#111111]
                         bg-white px-3 py-1 rounded-md shadow-sm"
            >
              {selectedMonth}월
        ...
        >
          {loading ? (
            ...
            <HomeSummary
              ...
              monthEnd={monthEnd}
              onOpenExpenses={() => (window.location.href = '/expenses')}
              onOpenFixed={() => (window.location.href = '/expenses?type=FIXED_EXPENSE')}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-64 rounded-xl bg-white p-4">
            ...
            <div className="relative" style={{ height: PICKER_H }}>
              <div
                className="pointer-events-none absolute left-0 right-0 border-t border-[#E6E6E6]"
              ...
              <div
                ...
                style={{ scrollbarWidth: 'none', WebkitOverflowScrolling: 'auto' } as React.CSSProperties}
              >
                ...
                {months.map((m) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ height: ITEM_H }}
                    >
                      <span className={active ? 'text-[#FF6200] font-semibold' : 'text-[#9CA3AF]'}>
                        {m}월
                      </span>
                    </div>
                  );
            ...
            <button
              className="mt-4 w-full py-2 rounded-md bg-[#FF6200] text-white font-medium"
              onClick={() => {

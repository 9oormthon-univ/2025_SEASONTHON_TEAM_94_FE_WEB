...
type ExtraProps = {
  ...
  renderDayContent?: (args: { date: Date }) => React.ReactNode;
};
...
function Calendar({
  ...
  renderDayContent,           
  ...props
}: React.ComponentProps<typeof DayPicker> & ExtraProps) {
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        //  DayButton에 renderDayContent를 넘겨서 children 대신 사용
        DayButton: (p) => <CalendarDayButton {...p} renderDayContent={renderDayContent} />,
...
// CalendarDayButton에 renderDayContent를 받아서 children 대신 렌더
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {renderDayContent ? renderDayContent({ date: day.date }) : props.children}
    </Button>
  );
}
